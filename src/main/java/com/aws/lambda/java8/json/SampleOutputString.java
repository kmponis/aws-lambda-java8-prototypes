...
public class SampleOutputString implements RequestHandler<Object, String> {
  ...
  public String handleRequest(Object input, Context context) {
    ...
    String sol1 = getSolution(N, NA, S, SA);
  ...
  private String getSolution(Integer N, int[] NA, String S, String[] SA) {
    // Integer
