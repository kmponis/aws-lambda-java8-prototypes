...
public class InputIntArrayIntArrayIntOutputInt implements RequestHandler<Object, Integer> {
	...
	public Integer handleRequest(Object input, Context context) {
		...
		int sol1 = functionGetSolution.apply(A, B, K);
