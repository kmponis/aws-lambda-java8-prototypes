...
import com.aws.lambda.java8.output.integer.InputIntOutputInt;
 ...
 */
public class InputIntOutputIntTest {

	private static Object input;

	@BeforeClass
	public static void createInput() throws IOException {
		String jsonString = "{\"tests\":[{\"A\":123456789,\"output\":9}" + ", {\"A\":1,\"output\":1}"
				+ ", {\"A\":123,\"output\":3}]}";
	...
	public void testSample() {
		InputIntOutputInt handler = new InputIntOutputInt();
