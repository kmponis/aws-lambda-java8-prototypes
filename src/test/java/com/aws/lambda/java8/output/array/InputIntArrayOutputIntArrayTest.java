...
import com.aws.lambda.java8.output.array.InputIntArrayOutputIntArray;
 ...
 */
public class InputIntArrayOutputIntArrayTest {

	private static Object input;

	@BeforeClass
	public static void createInput() throws IOException {
		String jsonString = "{\"tests\":[{\"A\":[1,2,3,4,5],\"output\":[1,2,3,4,5]}" + ", {\"A\":[1],\"output\":[1]}"
				+ ", {\"A\":[123],\"output\":[123]}]}";
	...
	public void testSample() {
		InputIntArrayOutputIntArray handler = new InputIntArrayOutputIntArray();
