...
import com.aws.lambda.java8.output.array.InputIntArrayIntOutputIntArray;
 ...
 */
public class InputIntArrayIntOutputIntArrayTest {

	private static Object input;

	@BeforeClass
	public static void createInput() throws IOException {
		String jsonString = "{\"tests\":[{\"A\":[1,2,3,4,5],\"K\":2,\"output\":[2,4,6,8,10]}"
				+ ", {\"A\":[1],\"K\":4,\"output\":[4]}" + ", {\"A\":[123],\"K\":5,\"output\":[615]}]}";
	...
	public void testSample() {
		InputIntArrayIntOutputIntArray handler = new InputIntArrayIntOutputIntArray();
